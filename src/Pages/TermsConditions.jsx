export default function TermsConditions() {
    return (
        <div className="container mx-auto text-lg py-10 sm:px-8 px-2">
            ...
            <p className="my-4">Welcome to Step Savvy!</p>
            <p className="my-4">
                These terms and conditions outline the rules and regulations for the use of
                Step Savvy's Website, located at http://www.stepsavvy.com.
            </p>
            <p className="my-4">
                By accessing this website we assume you accept these terms and conditions.
                Do not continue to use Step Savvy if you do not agree to take all of the
            ...
            <p className="my-4">
                We employ the use of cookies. By accessing Step Savvy, you agreed to use
                cookies in agreement with the Step Savvy's Privacy Policy.{" "}
            </p>
            <p className="my-4">
            ...
            <p className="my-4">
                Unless otherwise stated, Step Savvy and/or its licensors own the intellectual
                property rights for all material on Step Savvy. All intellectual property
                rights are reserved. You may access this from Step Savvy for your own
                personal use subjected to restrictions set in these terms and conditions.
            </p>
            <p className="my-4">You must not:</p>
            <ul className="list-disc px-6">
                <li>Republish material from Step Savvy</li>
                <li>Sell, rent or sub-license material from Step Savvy</li>
                <li>Reproduce, duplicate or copy material from Step Savvy</li>
                <li>Redistribute content from Step Savvy</li>
            </ul>
            <p className="my-4">
            ...
            <p className="my-4">
                ...
                opinions and information in certain areas of the website. Step Savvy does not
                filter, edit, publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of Step Savvy,its
                ...
                applicable laws, Step Savvy shall not be liable for the Comments or for any
            ...
            <p className="my-4">
                Step Savvy reserves the right to monitor all Comments and to remove any
            ...
            <p className="my-4">
                You hereby grant Step Savvy a non-exclusive license to use, reproduce, edit
            ...
            <p className="my-4">
                ...
                compensates the absence of Step Savvy; and (d) the link is in the context of
            ...
            <p className="my-4">
                ...
                e-mail to Step Savvy. Please include your name, your organization name,
            ...
            <p className="my-4">
                No use of Step Savvy's logo or other artwork will be allowed for linking
