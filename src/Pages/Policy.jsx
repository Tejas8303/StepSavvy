export default function Policy() {
    return (
        <div className="container mx-auto text-lg py-10 sm:px-8 px-2">
            ...
            <ul className="list-disc px-6">
                ...
                <li>
                    <p className="my-4">
                        ...
                        "Us" or "Our" in this Agreement) refers to Step Savvy, Jaipur, Rajsthan,
                        INDIA.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p className="my-4">
                        <strong>Website</strong> refers to Step Savvy, accessible from{" "}
                        <a
                            href="http://localhost:3000"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            http://www.stepsavvy.com
                        </a>
                    </p>
                </li>
                <li>
            ...
            <ul className="list-disc px-6">
                <li>By email: office@stepsavvy.com</li>
            </ul>
        </div>
